...
<body>
	<center>
			<a href="editmarks.php"><button class="edit_grades"> Edit Marks </button></a>
		</center>
	<center>
	<center> 
	   <div class="main_table" id="main_table">
		    ...
		    echo '<div class="table_row">'.'<div class="table_cell">'.$row['username'].'</div>'.'<div class="table_cell">'.$row['quiz1'].'</div>'.'<div class="table_cell">'.$row['quiz2'].'</div>'.'<div class="table_cell">'.$row['quiz3'].'</div>'.'<div class="table_cell">'.$row['a1'].'</div>'.'<div class="table_cell">'.$row['a2'].'</div>'.'<div class="table_cell">'.$row['a3'].'</div>'.'<div class="table_cell">'.$row['lab'].'</div>'.'<div class="table_cell">'.$row['midterm'].'</div>'.'<div class="table_cell">'.$row['exam'].'</div>'.'</div>';
		    			}
		    }
		    else{
